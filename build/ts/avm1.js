        ...
        (function (Lib) {
            var AVM1TextFormat = (function (_super) {
                ...
                AVM1TextFormat.createAVM1Class = function (context) {
                    return Lib.wrapAVM1NativeClass(context, true, AVM1TextFormat, [], ['align#', 'blockIndent#', 'bold#', 'bullet#', 'color#', 'font#',
                        'getTextExtent', 'indent#', 'italic#', 'kerning#', 'leading#',
                        'leftMargin#', 'letterSpacing#', 'rightMargin#', 'size#', 'tabStops#',
                        'target#', 'underline#', 'url#'], null, AVM1TextFormat.prototype.avm1Constructor);
                };
